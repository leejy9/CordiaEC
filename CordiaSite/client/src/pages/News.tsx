    ...
    return (
      <Layout>
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto text-center bg-white rounded-2xl shadow-sm border border-red-100 p-10">
              <h1 className="text-4xl sm:text-5xl font-bold text-cordia-dark mb-6">
                News
              </h1>
              <p className="text-lg text-red-600">
                Failed to load news articles. Please check the API deployment and database connection.
              </p>
            </div>
          </div>
        </section>
