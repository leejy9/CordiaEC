    ...
    <Layout>
      ...
      <section className="relative py-20 bg-cordia-dark text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">K-Diaspora Community</h1>
          <p className="text-lg text-white/80">Stories and activities from our global Korean diaspora community</p>
        </div>
      </section>
